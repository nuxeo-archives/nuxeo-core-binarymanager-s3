...
public abstract class AbstractS3BinaryManager extends BinaryCachingManager {

    protected static final Log log = LogFactory.getLog(S3BinaryManager.class);
    ...
    public static class S3BinaryGarbageCollector implements
        ...
        protected final AbstractS3BinaryManager binaryManager;
        ...
        public S3BinaryGarbageCollector(AbstractS3BinaryManager binaryManager) {
    ...
    public AbstractS3BinaryManager() {
        super();
    }
    ...
    protected class TempEntry {
        protected File tmpFile;
        protected String digest;

        protected TempEntry(File tmpFile, String digest) {
            this.tmpFile=tmpFile;
            this.digest=digest;
        }
    }

    protected TempEntry doTempStorage(InputStream in) throws IOException {
        ...
        return new TempEntry(tmp, digest);
    }

    protected void doStoreInS3(TempEntry tmpEntry) throws IOException {
